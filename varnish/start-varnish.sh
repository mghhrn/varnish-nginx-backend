...
varnishd -j unix,user=varnishd -F -f ${VARNISH_VCL_PATH} -t ${VARNISH_TTL} -s malloc,${VARNISH_MEMORY} -a 0.0.0.0:${VARNISH_PORT} -p http_req_hdr_len=16384 -p http_resp_hdr_len=16384
